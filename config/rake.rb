...
COMPANY_NAME = "Rails Continuous Integration"
...
SITE_COOKBOOK_PATH = "/tmp/chef_solo/site-cookbooks"

# Where to install roles
ROLE_PATH = "/tmp/chef_solo/roles"

# Chef Config Path
CHEF_CONFIG_PATH = "/home/ubuntu/solo.rb"
